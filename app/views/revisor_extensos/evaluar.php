...
<div class="card">
    <div class="card-header"><h5>Formulario de Evaluación</h5></div>
    ...
    <div class="card-body">
        <form id="formEvaluacionExtenso">
            ...
            <div class="mb-3"><p>6. ¿Los hallazgos de la investigación contribuyen a la reflexión y/o explicación del tema tratado?</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Elementos del Formulario 2 (Subir PDF Firmado) ---
    ...
    const originalBtnFirmadoText = btnSubirFirmado.innerHTML;

    // Lógica para mostrar/ocultar el campo de argumento de rechazo
    ...
    // Listener para el primer formulario (guardar dictamen)
    formEvaluacion.addEventListener('submit', function(event) {
        ...
        .then(data => {
            if (data.error) {
                ...
                // Si hay éxito, mostramos el link de descarga y el siguiente paso
        ...
        .catch(error => {
            ...
            mensajeDiv.innerHTML = `<div class="alert alert-danger">Ocurrió un error. Revisa la consola.</div>`;
            // Si hay error, restauramos el botón
            submitBtn.disabled = false;
            submitBtn.innerHTML = originalBtnText;
        });
    ...
    // Listener para el segundo formulario (subir PDF firmado)
