<div class="container-fluid px-4 mt-4">
    ...
    <?php
    $historial = $historialSeguimientoAceptados ?? [];
    $tituloCard = 'Extensos aceptados (dictamen favorable y publicable por revisores)';
    $cardHeaderClass = 'bg-success text-white';
    $mensajeVacioHistorial = 'No hay extensos en esta categoría.';
    $cardIconClass = 'bi-check2-circle';
    require __DIR__ . '/_tabla_historial_seguimiento.php';

    $historial = $historialSeguimientoPendientes ?? [];
    $tituloCard = 'En seguimiento: pendientes de veredicto, con correcciones o rechazados';
    $cardHeaderClass = 'bg-dark text-white';
    $mensajeVacioHistorial = 'No hay extensos en seguimiento en esta categoría.';
    $cardIconClass = 'bi-hourglass-split';
    require __DIR__ . '/_tabla_historial_seguimiento.php';
    ?>
